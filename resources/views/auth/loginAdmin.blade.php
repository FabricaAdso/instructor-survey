        ...
        <div class="hidden w-2/5 h-full bg-cover lg:block">
            ...
            <div class="flex items-center justify-center w-full max-w-md p-8 bg-white rounded-lg shadow-md lg:w-3/5">
                <div class="w-full space-y-6">
                    ...
                    <h1 class="text-2xl font-bold text-center text-gray-700">Login Administrador</h1>
                    ...
                    <form method="POST" action="{{ route('login.admin.submit') }}" class="space-y-4">
                        ...
                        <input type="text" id="username" name="username" placeholder="Ingresa tu nombre de usuario o documento"
                            class="block w-full px-4 py-2 mt-1 text-gray-700 bg-gray-100 border border-gray-300 rounded-lg focus:ring focus:ring-green-300 focus:outline-none" required>
                    </div>

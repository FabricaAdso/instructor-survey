            ...
            @foreach ($instructors as $instructor)
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <button type="button" onclick="window.open('{{ route('leaderreportsGeneral', $instructor->id) }}', '_blank')" class="general-btn general-btn-data">
                            General
                        </button>
        ...
        <div id="modal-{{ $instructor->id }}" class="instructor-modal">
            <div class="modal-content">
                ...
                <div style="width: 100%; height: 220px; overflow-y: auto;">
                    @include('leader.menu.modalCourses', ['instructor' => $instructor])
                </div>
